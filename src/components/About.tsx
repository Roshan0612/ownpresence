...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-20" style={{ background: 'var(--dora-bg-secondary)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="about-badge inline-flex items-center px-4 py-2 glass rounded-full shadow-md mb-6">
          ...
          >
            <div
              className="w-full h-[480px] rounded-xl overflow-hidden shadow-2xl relative border border-gray-700"
